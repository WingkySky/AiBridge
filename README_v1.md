> ⚠️ **归档文档（v1 / Python）**：这是 AGN-SDK v1（Python）的旧 README，仅作历史参考，不再迭代。
> 当前主线为 **AIBridge v2**（Rust 核心 + Python / JS-TS / Go / JVM / .NET 五语言原生绑定），见 [README.md](README.md)。
> v1 -> v2 破坏性升级对照见 [迁移指南](docs/migration-guide.md)。

# 🤖 AGN-SDK（v1 / Python，归档）
...
**当前版本**：[AIBridge v2（Rust + 五语言绑定）](README.md) | [v1 -> v2 迁移指南](docs/migration-guide.md)
