...
- [Original README (v1)](https://github.com/WingkySky/AiBridge/blob/v1.3.3/README_v1.md) — Python v1 docs (see git tag `v1.3.3`; removed from the repository after full migration to v2)
